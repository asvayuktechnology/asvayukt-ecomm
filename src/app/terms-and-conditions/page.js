        ...
        <div className="bg-white text-black">
          <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-3 sm:px-10">
            ...
            <p>
              ...
              the use of Asvayuk Ecommerce's Website, located at
            ...
            <p>
              ...
              this website and compliant with the Company’s terms. "The
              Company", "Ourselves", "We", "Our" and "Us", refers to our
              Company. "Party", "Parties", or "Us", refers to both the Client
              and ourselves. All terms refer to the offer, acceptance, and
              consideration of payment necessary to undertake the process of our
              assistance to the Client in the most appropriate manner for the
              purpose of meeting the Client’s needs in accordance with the
              prevailing law of the Netherlands.
            </p>
            ...
            <p>
              ...
              Privacy Policy. Most interactive websites use cookies to enable
              the functionality of certain areas and improve user experience.
            ...
            <p>
              Unless otherwise stated, Asvayuk Ecommerce and/or its licensors
              own the intellectual property rights for all material on Asvayuk
              Ecommerce. All rights are reserved. You may access content from
              Asvayuk Ecommerce for your own personal use subject to
            ...
            <p>
              ...
              Asvayuk Ecommerce does not filter, edit, or review comments prior
              to posting. Comments do not reflect the views of Asvayuk
              Ecommerce, and we shall not be liable for any damages resulting
            ...
            <p>
              ...
              You agree to defend us against any claims arising from your
              website. No links should appear on any website that may be
              interpreted as libelous, obscene, criminal, or in violation of any
              third-party rights.
            </p>
            ...
            <p>
              We reserve the right to request removal of all or specific links
              to our website. You agree to remove links upon request. We may
              amend these terms and our linking policy at any time. By
              continuing to link to our site, you agree to these terms.
            </p>
            ...
            <ul className="list-disc list-inside pl-4 space-y-1">
              <li>
                1. Limit or exclude liability for death or personal injury
              </li>
              <li>
              ...
              <li>
                4. Exclude any liability that cannot be excluded under law
              </li>
            </ul>
            <p>
              The limitations above apply to all liabilities including those
              arising in contract, tort, or statutory duty. As long as the
              website and its services are provided free of charge, we will not
