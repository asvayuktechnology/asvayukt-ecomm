      ...
      <div className="bg-white text-black">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          ...
          <p>
            ...
            recorded by Asvayuk Ecommerce and how we use it...
          </p>
          <p>
            This Privacy Policy applies only to our online activities and is
            valid for visitors to our website with regards to the information
            that they shared and/or collect in Asvayuk Ecommerce. This policy is
            not applicable to any information collected ...
          </p>
          ...
          <p>
            ...
            data or information via email or telephone. If you receive such a
            request, do not respond and forward the message to us.
          </p>
          ...
          <ol className="list-decimal list-inside space-y-2 mt-2">
            ...
            <li>
              Send you emails for updates, marketing, and promotional purposes.
            </li>
          ...
          <p>
            ...
            collected includes IP addresses, browser type, ISP, date/time stamp,
          ...
          <p>
            ...
            advertising partners of Asvayuk Ecommerce. Third-party ad servers or
            ad networks use technologies like cookies or Web Beacons sent to
            users’ browsers, and automatically receive...
          </p>
          ...
          <p>
            Under the CCPA, California consumers have the right to request data
            disclosure, deletion, or opt-out from the sale of personal data. If
          ...
          <p>
            ...
            under 13. If your child has provided this information, please
