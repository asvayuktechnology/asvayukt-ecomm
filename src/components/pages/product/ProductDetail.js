  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        setProduct(found);
        setRelated(products.filter((p) => p.id !== found?.id).slice(0, 10));
      } catch (error) {
              ...
              <div className="flex flex-col md:flex-row">
                <div className="flex-shrink-0 xl:pr-10 lg:block w-full mx-auto md:w-6/12 lg:w-5/12 xl:w-4/12 relative">
                  ...
                  <Image
                    ...
                    width={650}
                    height={650}
                    src={product.image || AppImages.home2.products.product4}
                ...
                <div className="md:w-2/3 w-full md:pr-6">
                  ...
                  <p className="text-sm leading-6 text-gray-500 md:leading-7 mt-4">
                    {product.description}
                  </p>
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-sm text-gray-500">
                      For lots of traffic from social network, share this
                      product
                    </p>
